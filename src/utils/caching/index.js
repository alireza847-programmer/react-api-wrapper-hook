...
const getLocalStorageItem = (key) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
      const stringCaches = yield (_a = storage.default) === null ||
      _a === void 0
        ? void 0
        : _a.getItem(key);
...
const setLocalStorageItem = (key, value) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    try {
      yield (_b = storage.default) === null || _b === void 0
        ? void 0
        : _b.setItem(key, JSON.stringify(value));
    } catch (error) {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (cacheItem) {
      ...
      const fetchTime = new Date(
        cacheItem === null || cacheItem === void 0
          ? void 0
          : cacheItem.fetchTime
      );
